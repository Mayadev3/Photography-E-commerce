  ...
  const getLonelies = async () => {
    try {
      let response = await fetch(
        "http://localhost:3003/category/categoryLonely/pictures"
      );
      if (response.ok) {
    ...
    <div className="LonelyCarousel" id="lonely">
      <div className="lonely-grid-carousel">
        <div
          ...
          className="carousel slide container-lonely"
            ...
            {lonelyPics.map((picture, index) => (
              ...
              >
                <img
                  ...
                  className="d-block w-100 carousel-img-lonely"
                  alt={picture.title}
                />
